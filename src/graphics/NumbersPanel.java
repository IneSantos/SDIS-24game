            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getX() >= 0 && e.getX() <= 200) {
                    if (e.getY() >= 0 && e.getY() <= 200) {
                        ...
                        game.setEquation(String.valueOf(challenges.get(0)));
                        ...
                        game.setEquation(String.valueOf(challenges.get(2)));
